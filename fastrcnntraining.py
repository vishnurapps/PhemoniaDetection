...
from fastrcnnutils import get_data_loader, Averager, train, validate
from fastrcnnbackbone import model
...
model.load_state_dict(torch.load('fasterrcnn_resnet50_fpn.pth' ,map_location=torch.device('cuda')))
